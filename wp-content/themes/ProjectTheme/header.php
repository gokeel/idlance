		...
		<div id="header">
			<div class="top-bar-bg">
				<div class="top-bar wrapper"> 
                	...
                	<div class="rss_icn">
                    <div class="sk1_pr_rss"><a href="<?php bloginfo('siteurl'); ?>/?feed=rss&post_type=project"><img src="<?php bloginfo('template_url'); ?>/images/rss_icon.png" 
                    border="0" width="19" height="19" alt="rss icon" /></a></div>
                    <div class="sk2_pr_rss"><a href="<?php bloginfo('siteurl'); ?>/?feed=rss&post_type=project" class="feed_prj"><?php _e('Project RSS Feed','ProjectTheme'); ?></a></div></div>
                           ...
                           <li> <a href="<?php echo projectTheme_advanced_search_link2(); ?>"><?php echo __("Advanced Search",'ProjectTheme'); ?></a> </li>
							...
							<?php
								...
								if(is_user_logged_in())
								{
									...
									<li><a href="<?php echo projectTheme_my_account_link(); ?>"><?php echo $u->user_login." - ".__("MyAccount",'ProjectTheme'); ?></a></li>
