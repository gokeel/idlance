		 ...
		 if ( $count > 0 ){
			...
			$stuffy = '';
				...
				$mese = '';
					...
					$mese .= '<ul>';
					$mese .= "<a href='#' class='parent_taxe' rel='taxe_project_cat_".$term->term_id."' ><img alt='location' src=\"".get_bloginfo('template_url')."/images/posted.png\" width=\"20\" height=\"20\" /></a> 
					...
					foreach ( $terms2 as $term2 ) 
					{
						...
						if($terms3)
						{
							...
							foreach ( $terms3 as $term3 ) 
							{
								...
								$total_ads += $tt;
								$mese2 .= "<li><a href='".get_term_link($term3->slug,"project_location")."'>" . $term3->name." (".$tt.")</a></li>";
