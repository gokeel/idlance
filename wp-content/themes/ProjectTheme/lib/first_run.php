...
***************************************************************************/
	...
	$opt = get_option('ProjectTheme_upd138saa_bass1');
	
	if(empty($opt))
	{
		global $wpdb;
		update_option('ProjectTheme_upd138saa_bass1','y');
	...
	$opt = get_option('ProjectTheme_upd138_bass4a');
	...
	if(empty($opt))
	{
		...
		global $wpdb;
		update_option('ProjectTheme_upd138_bass4a','y');
