			...
			get_header();
                ...
                <div class="box_content">                                          
						  ...
						  <input type="hidden" name="action" value="register" />	
							...
							<input type="radio" class="do_input" name="user_tp" id="user_tp" value="service_provider" checked="checked" /> <?php _e('Service Provider/Freelancer',$current_theme_locale_name); ?><br/>
                            <input type="radio" class="do_input" name="user_tp" id="user_tp" value="business_owner" /> <?php _e('Service Contractor/Business Owner',$current_theme_locale_name); ?><br/>
							</p>
